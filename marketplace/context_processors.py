...
def get_cart_amount(request):
    ...
    if request.user.is_authenticated:
        ...
        for item in cart_items:
            ...
            subtotal += (fooditem.price * item.quantity) #subtotal = subtotal + (fooditem * item.quantity)
        ...
        for i in get_tax:
            ...
            # send dict type like {'CGST':{'9.00':'2.10'}}  2.10 is tax amount
